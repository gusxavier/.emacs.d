...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nofrils-acme-theme zenburn-theme meghanada rjsx-mode flycheck-joker expand-region which-key helm-cider py-isort lsp-mode cquery company-anaconda flycheck-clojure spaceline intero haskell-mode restclient vue-mode markdown-mode doom-themes))))
(custom-set-faces
